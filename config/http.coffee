...
###
authCookieHere = (cookies)->
  authCookieStatus =  ['unlogin','loggedin'][+ cookies.hasOwnProperty 'cafe_session']
  console.log "authCookieStatus:"+authCookieStatus
###
...
custom = ->
  ...
  (request, response, next) ->
    ...
    #authCookieHere(request.cookies) if request.url == '/' 
